...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=1.0, alpha=0.5):
        ...
        self.a = 0.002            # Factor in decay function

        ## Working experience:
        ## 1. a:0.025; decay:5th; learnrate:0.3; tolerance:0.02; S:A+; R:D
    ...
    def reset(self, destination=None, testing=False):
        ...
        self.trial += 1
        # self.epsilon = self.epsilon - 0.05    # Default decaying
        # self.epsilon = pow(self.a, self.trial)
...
def run():
    ...
    sim.run(tolerance=0.0000001, n_test=10)
